...
(function () {
    ...
    function wireWalkthrough() {
        ...
        groups.forEach(function (g) {
            ...
            if (box === null || expandAll === null || collapseAll === null)
                throw new Error(`Group ${gid} is missing its controls`);
        ...
        document.querySelectorAll('.file').forEach(function (f) {
            ...
            if (box === null || toggle === null)
                throw new Error(`File ${fid} is missing its controls`);
        ...
        function openHashTarget() {
            ...
            if (el?.classList.contains('file') === true)

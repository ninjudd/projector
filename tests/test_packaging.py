...
class PackagingTests(unittest.TestCase):
    ...
    def test_review_loops_share_one_review_method(self) -> None:
        ...
        # posted, and implement-project to apply the same passes before a review
        ...
        for name in ("start-fix-loop", "implement-project"):
            text = (ROOT / "skills" / name / "SKILL.md").read_text()
    ...
    def test_three_skills_share_one_set_of_code_guidelines(self) -> None:
        ...
        for name in ("start-review-loop", "start-fix-loop", "implement-project"):
            text = (ROOT / "skills" / name / "SKILL.md").read_text()

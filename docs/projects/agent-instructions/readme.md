...
- `plan-project`, `implement-project`, and `finish-project` skills: the
  validation step says to resolve any warning `project check` prints, and
  that `project init` refreshes a stale Projector section.

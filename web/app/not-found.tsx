  ...
  return (
    <>
      ...
      >
        ...
        <Link
          href="/"
          className="mt-10 inline-flex w-fit items-center gap-2 rounded-md bg-fg px-5 py-2.5 text-sm font-medium text-bg transition-colors hover:bg-accent hover:text-accent-fg"
        >
